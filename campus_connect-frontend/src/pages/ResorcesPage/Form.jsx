...
function Form() {
  ...
  return (
    <>
      <div
        className={`personelEvent-container ${LightTheme ? "" : "dark"}`}
          ...
          <Box sx={{ minWidth: "43ch" }}>
            <FormControl fullWidth>
              <InputLabel
                ...
                className={`checkbox-label ${LightTheme ? "" : "dark"}`}
              >
                Subject
              </InputLabel>
              <Select
              ...
              >
                {subCategory.map((name) => (
                  ...
                  >
                    <Checkbox
                      checked={subCategoryValue.indexOf(name) > -1}
                      className={`menuItem ${LightTheme ? "" : "dark"}`}
                    />
                    <ListItemText
                      primary={name}
